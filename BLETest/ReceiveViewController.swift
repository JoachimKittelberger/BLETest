...
class ReceiveViewController: UIViewController, UITableViewDataSource, CBCentralManagerDelegate, CBPeripheralDelegate {
    
    @IBOutlet weak var UISwitchReceive: UISwitch!
    @IBOutlet weak var UITableViewReceive: UITableView!
    ...
    @IBAction func OnUISwitchReceiveValueChanged(_ sender: UISwitch) {
        print("OnUISwitchReceiveValueChanged \(sender.isOn ? "ON" : "OFF")")
        if sender.isOn {
            print("Central Manager: Start scanning")
            startScanning()
        } else {
            print("Centra Manager: Stopp scanning")
    ...
    var entries = ["Testeintrag 1", "Testeintrag 2", "Testeintrag 3"]
    ...
    override func viewDidLoad() {
        ...
        UITableViewReceive.dataSource = self
        self.UISwitchReceive.setOn(false, animated: false)
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "myReceiveObject", for: indexPath as IndexPath)
...
// TODO:                textView.text = message
                entries[0] = message
                UITableViewReceive.reloadData()
    ...
    */
    ...
    // Tutorial unter https://codingtutor.de/uitableview-uitableviewcontroller-swift/
