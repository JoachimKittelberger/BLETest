...
class SendViewController: UIViewController, UITextFieldDelegate, CBPeripheralManagerDelegate {

    
    @IBOutlet weak var UITextFieldName: UITextField!
    @IBOutlet weak var UILabelClock: UILabel!
    @IBOutlet weak var UISwitchSend: UISwitch!
    ...
    @IBAction func OnUITextFieldNameEditingDidEnd(_ sender: UITextField) {
        print("OnUITextFieldNameEditingDidEnd")
    }
    @IBAction func OnUISwitchSendValueChanged(_ sender: UISwitch) {
        print("OnUISwitchSendValueChanged \(sender.isOn ? "ON" : "OFF")")
        if sender.isOn {
    ...
    override func viewDidLoad() {
        ...
        // show start screen for a longer time
        Thread.sleep(forTimeInterval: 1)
        
        self.UISwitchSend.setOn(false, animated: false)
        
        // hide the keyboard then tapped in the view
        self.UITextFieldName.delegate = self        // handle the RETURN-Key
    ...
    // hide the keybpard then RETURN-Key is pressed
    func textFieldShouldReturn(_ textField: UITextField) -> Bool {
        UITextFieldName.resignFirstResponder()
        return true
    }
    
    // hide the keybpard then tapped in the view
